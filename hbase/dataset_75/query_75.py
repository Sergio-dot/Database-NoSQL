...
def query1():
    ...
    table = connection.table("TRANSACTION_Q1_75")
...
def query2():
    start = time.time()
    connection = happybase.Connection()
    table = connection.table("TRANSACTION_Q2_75")
...
# Replace results/time_qx_75.csv where x matches the number of the query
# example when assigning temp = query5() replace with results/time_q5_75.csv
# this will execute query5() and save the results under the results folder, in the time_q5_75.csv file

with open('results/time_q1_75.csv', mode='w', newline='') as csv_file:
