...
def create_table_q1():
    try:
        conn = connection_db()
        print("\n#####################################")
        print("# Creating table TRANSACTION_Q1_25 #")
        print("#####################################\n")
        conn.create_table('TRANSACTION_Q1_25', { 'Transaction_Data':dict() })
        print("Table created.")
    except Exception as e:
        print("Error " + e)
    conn.close()
...
def create_table_q2():
    try:
        conn = connection_db()
        print("\n#####################################")
        print("# Creating table TRANSACTION_Q2_25 #")
        print("#####################################\n")
        conn.create_table('TRANSACTION_Q2_25', { 'Transaction_Data':dict() })
        print("Table created")
    except Exception as e:
        print("Error " + e)
    conn.close()
...
def create_table_q3():
    try:
        conn = connection_db()
        print("\n#####################################")
        print("# Creating table TRANSACTION_Q3_25 #")
        print("#####################################\n")
        conn.create_table('TRANSACTION_Q3_25', { 'Transaction_Data':dict() })
        print("Table created")
    except Exception as e:
        print("Error " + e)
    conn.close()
...
def push_data_q1():
    try:
        conn = connection_db()
        print("\n###################################################")
        print("# Importing dataset into table TRANSACTION_Q1_25 #")
        print("###################################################\n")
        table = conn.table('TRANSACTION_Q1_25')
        csvfile = open("dataset_25.csv", "r")
...
def push_data_q2():
    try:
        conn = connection_db()
        print("\n###################################################")
        print("# Importing dataset into table TRANSACTION_Q2_25 #")
        print("###################################################\n")
        table = conn.table('TRANSACTION_Q2_25')
        csvfile = open("dataset_25.csv", "r")
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            table.put(row[0], {
...
def push_data_q3():
    try:
        conn = connection_db()
        print("\n###################################################")
        print("# Importing dataset into table TRANSACTION_Q3_25 #")
        print("###################################################\n")
        table = conn.table('TRANSACTION_Q3_25')
        csvfile = open("dataset_25.csv", "r")
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            table.put(row[0], {
...
def scan_table_q1():
    try:
        ...
        conn = connection_db()
        print("\n##############################################")
        print("# Scanning content: table TRANSACTION_Q1_25 #")
        print("##############################################\n")
        table = conn.table('TRANSACTION_Q1_25')
...
# table TRANSACTION_Q1_25
create_table_q1()
push_data_q1()
scan_table_q1()

# table TRANSACTION_Q2_25
create_table_q2()
push_data_q2()
scan_table_q2()

# table TRANSACTION_Q3_25
create_table_q3()
push_data_q3()
scan_table_q3()